...
const unisWithUni = []
unisWithUni.push(
  graduates.filter(graduate => graduate.university.includes('Uni'))
)
...
const popArr = zooAnimals.map(animal => animal.population)

const reducer = (accumulator, item) => accumulator + item

console.log(popArr.reduce(reducer, populationTotal))
